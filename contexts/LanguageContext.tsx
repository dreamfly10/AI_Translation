...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'auth.resetCodeSent': 'Reset code sent! Check your email and enter the code below.',
    'auth.backToSignIn': 'Back to Sign In',
    'auth.verifyOTP': 'Verify Code',
    'auth.otpDescription': 'Enter the 6-digit code sent to your email',
    'auth.otpRequired': 'Please enter the 6-digit code',
    ...
    'auth.invalidResetToken': 'Invalid or missing reset token. Please request a new password reset.',
    ...
    'processor.headline': 'Understand content first — then express it clearly, your way.',
    'processor.subheadline': 'Expression Copilot helps you break down meaning and structure, then express ideas clearly using default styles or your own.',
    ...
    'processor.style.helptip': 'Thinking Style controls how the AI reasons and structures its response. Choose a style that matches how you want the ideas organized — creative, critical, or exploratory.',
    'processor.rewritingLevel.helptip': 'Degree of Rewriting controls how much the original content is transformed.\nLow keeps the structure close to the source; High re-expresses ideas more freely.',
  ...
  zh: {
    ...
    'auth.forgotPasswordDescription': '输入您的邮箱地址，我们将向您发送重置密码的验证码。',
    'auth.sendResetCode': '发送验证码',
    'auth.sending': '发送中...',
    'auth.resetCodeSent': '验证码已发送！请查看您的邮箱并输入验证码。',
    'auth.backToSignIn': '返回登录',
    'auth.verifyOTP': '验证验证码',
    'auth.otpDescription': '请输入发送到您邮箱的 6 位验证码',
    'auth.otpRequired': '请输入 6 位验证码',
    'auth.verifying': '验证中...',
    'auth.verify': '验证',
    'auth.resendCode': '重新发送验证码',
    'auth.resending': '重新发送中...',
    'auth.resendIn': '{seconds} 秒后重新发送',
    'auth.resetPassword': '重置密码',
    'auth.resetPasswordDescription': '请在下方输入您的新密码。',
    ...
    'auth.redirectingToSignIn': '正在跳转到登录页面...',
    'auth.invalidResetToken': '无效或缺失的重置令牌。请重新申请密码重置。',
    ...
    'processor.headline': '先理解内容 — 然后以您的方式清晰地表达。',
    'processor.subheadline': '智能表达助理帮助您分解含义和结构，然后使用默认风格或您自己的风格清晰地表达想法。',
    ...
    'processor.style.helptip': '思维风格控制 AI 如何推理和构建其回应。选择一种与您希望组织想法的方式相匹配的风格 — 创造性、批判性或探索性。',
    'processor.rewritingLevel.helptip': '改写程度控制原始内容被转换的程度。\n低保持结构接近源内容；高更自由地重新表达想法。',
